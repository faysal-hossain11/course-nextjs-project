        ...
        <div className="main-max-width">
          <div className="section-title mb-50 position-relative">
            ...
            <div className="d-flex justify-content-between">
              ...
              <div className="sorting-menu style-2">
                <ul>
                  <li
                  ...
                  <li
                    className={
                      filter === "Business" ? "filter active" : "filter"
                    }
          ...
          <div className="course-mix-wrapper">
            <div className="row">
              {filteredCourses.map((course) => (
                <div
                  key={course.id}
                  className="col-lg-4 col-sm-6 mix-target course-item"
                >
                  <CourseCard
            ...
            <div className="row">
              {courses.map((course) => (
                <div
                  key={course.id}
                  className={`col-lg-4 col-sm-6 mix-target course-item ${
                    filter !== "all" && !course.category.includes(filter)
                      ? "inactive"
                      : ""
                  }`}
                >
                  <CourseCard courseContent={course} cardImg={course.cardImg} authorImg={course.authorImg} />
                </div>
              ))}
            </div>
          </div> */}
...
export default CourseFiltersTwo;
