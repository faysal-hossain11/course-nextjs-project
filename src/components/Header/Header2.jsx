...
const Header2 = () => {
  ...
  const hadleMenuToggle = () => {
    setMenuToggle(!menuToggle);
  }
  return (
    <>
      <div className="navbar-area style-one style-2 stickyHeader" id="navbar">
        <div className="container">
          <div className="main-max-width">
            <nav className="navbar insocour-nav navbar-expand-lg">
              <Link className="navbar-brand" href="/">
                <Image className="logo-light" src={Logo} alt="logo" />
              </Link>
              <div className="newToggleBtn other-options d-flex flex-wrap justify-content-end align-items-center d-lg-none">
              ...
              {menuToggle && (
                        ...
                        <ul className="dropdown-menu list-unstyle">
                          ...
                          <li className="nav-item">
                            <Link
                              href="instructor-two"
                              className={`nav-link ${
                                pathname === "/instructor-two" ? "active" : ""
                              }`}
                            >
                              Instructor Tow
                            </Link>
                ...
                <div className="option-item style-2 d-flex align-items-center">
                  ...
                  <Link href="/cart" className="shop-btn">
                    <i className="ri-shopping-cart-2-line"></i>
                    <span className="cart-number style-2">1</span>
                  </Link>
                  <Link href="/sign-up" className="btn style-one style-2">
                    Sign up
                  </Link>
                </div>
              </div>
              ...
              <ul className="responsive-menu-items">
                ...
                <li className="responsive-menu-list">
                  ...
                  <ul className="responsive-menu-items">
                    ...
                    <li>
                      <Link href="/instructor-sidebar">Instructor Sidebar</Link>
                    </li>
                    <li>
